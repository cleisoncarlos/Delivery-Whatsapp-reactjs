...
<div className="col-lg-4 col-md-6 col-sm-6 mb-3"  key={product.id}>
...
<img src='https://picsum.photos/800/600' className="img-fluid" alt='...'/>
 ...
 <h4 className="text-secondary">R$ {product.price}</h4>
    <button className="btn btn-warning" onClick={() => addToCart(product)}><ShoppingCartSimple size={18}  weight="bold" /> Adicionar</button>
